...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sphinx-intl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sphinx-intl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sphinx-intl
# for installing globally
pixi global install sphinx-intl
```
...
It is possible to list all of the versions of `sphinx-intl` available on your platform:
...
```
pixi search sphinx-intl --channel conda-forge
```
